...
@NgModule({
  declarations: [CatTableComponent, CatTable2Component, CurrentPreviousComponent, FamilyLifestyleComponent, FormComponent, FormLayoutComponent, HeaderComponent, NewPetInfoComponent, PhysicalCharacteristicsComponent, ReferencesComponent, YourHomeComponent],
  imports: [
    CommonModule,
